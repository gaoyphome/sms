...
import com.bmac.ffan.common.constant.dictmap.UserDict;
...
import com.bmac.ffan.core.shiro.ShiroUser;
import com.bmac.ffan.core.util.ToolUtil;
import com.bmac.ffan.modular.system.dao.UserMgrDao;
import com.bmac.ffan.modular.system.factory.UserFactory;
import com.bmac.ffan.modular.system.transfer.UserDto;
import com.bmac.ffan.modular.system.warpper.UserWarpper;
...
public class UserMgrController extends BaseController {
    ...
    @Resource
    private CcSysUserMapper userMapper;
    ...
    public String roleAssign(@PathVariable Integer userId, Model model) {
        ...
        CcSysUser user = (CcSysUser) Db.create(CcSysUserMapper.class).selectOneByCon("id", userId);
    ...
    public String userEdit(@PathVariable Integer userId, Model model) {
        ...
        assertAuth(userId);
        CcSysUser user = this.userMapper.selectById(userId);
    ...
    public Tip add(@Valid UserDto user, BindingResult result) {
        ...
        // 判断账号是否重复
        CcSysUser theUser = managerDao.getByAccount(user.getAccount());
        if (theUser != null) {
    ...
    @ResponseBody
    public CcSysUser view(@PathVariable Integer userId) {
        if (ToolUtil.isEmpty(userId)) {
            throw new BussinessException(BizExceptionEnum.REQUEST_NULL);
        }
        assertAuth(userId);

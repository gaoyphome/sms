 ...
 * @Author: Buff
 * @Description:
 * @Date: Created in 2017/12/21 17:17
 */
public class LocalCardDiscountWarpper extends BaseControllerWarpper {
    public LocalCardDiscountWarpper(Object obj) {
        super(obj);
    }
    ...
    protected void warpTheMap(Map<String, Object> map) {
        ...
        if(ToolUtil.isNotEmpty(obj)){
            if("0".equals(obj.toString())){
                map.put("cardPhyType","未知 (00)");
            }else if("1".equals(obj.toString())){
                map.put("cardPhyType","MifareI(S50)卡 (01)");
            }else if("2".equals(obj.toString())){
                map.put("cardPhyType","MifarePro(或兼容)卡 (02)");
            }else if("3".equals(obj.toString())){
                map.put("cardPhyType","Ultra-Light (03)");
            }else if("5".equals(obj.toString())){
                map.put("cardPhyType","MifareI(S70)卡 (05)");
            }
        }
        ...
        obj = map.get("cardAttr");
        if(ToolUtil.isNotEmpty(obj)){
            if("1".equals(obj.toString())){
                map.put("cardAttr","普通储值卡 (01)");
            }else if("2".equals(obj.toString())){
                map.put("cardAttr","计次卡 (02)");
            }else if("3".equals(obj.toString())){
                map.put("cardAttr","定期卡 (03)");
            }else if("4".equals(obj.toString())){
                map.put("cardAttr","特殊储值卡 (04)");
            }
        }
    ...
    public static void main(String[] args) {
        System.out.println(new BigDecimal("10.0").stripTrailingZeros());
    }
}

...
import com.bmac.ffan.common.constant.state.BizLogType;
...
public class LogController extends BaseController {
    ...
    @Resource
    private CcSysOperationLogMapper operationLogMapper;
    ...
    public Object detail(@PathVariable Integer id) {
        CcSysOperationLog operationLog = operationLogMapper.selectById(id);

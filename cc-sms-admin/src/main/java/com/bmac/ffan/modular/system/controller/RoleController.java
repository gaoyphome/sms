...
import com.bmac.ffan.common.constant.dictmap.RoleDict;
...
import com.bmac.ffan.common.persistence.model.CcSysRole;
import com.bmac.ffan.core.base.controller.BaseController;
import com.bmac.ffan.core.base.tips.Tip;
import com.bmac.ffan.core.cache.CacheKit;
...
import com.bmac.ffan.modular.system.warpper.RoleWarpper;
...
public class RoleController extends BaseController {
    ...
    public String roleEdit(@PathVariable Integer roleId, Model model) {
        ...
        CcSysRole role = this.roleMapper.selectById(roleId);
    ...
    @ResponseBody
    public Tip add(@Valid CcSysRole role, BindingResult result) {
        if (result.hasErrors()) {
            throw new BussinessException(BizExceptionEnum.REQUEST_NULL);
        }
        role.setId(null);
    ...
    @Permission(Const.ADMIN_NAME)
    @ResponseBody
    public Tip edit(@Valid CcSysRole role, BindingResult result) {
        if (result.hasErrors()) {
            throw new BussinessException(BizExceptionEnum.REQUEST_NULL);
        }
    ...
    public List<ZTreeNode> roleTreeListByUserId(@PathVariable Integer userId) {
        CcSysUser theUser = this.userMapper.selectById(userId);

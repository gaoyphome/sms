...
import com.bmac.ffan.common.constant.dictmap.DeptDict;
...
import com.bmac.ffan.modular.system.dao.DeptDao;
import com.bmac.ffan.modular.system.service.IDeptService;
import com.bmac.ffan.modular.system.warpper.DeptWarpper;
...
public class DeptController extends BaseController {
    ...
    @Permission
    @ResponseBody
    public Object add(CcSysDept dept) {
    ...
    @Permission
    @ResponseBody
    public Object update(CcSysDept dept) {
    ...
    private void deptSetPids(CcSysDept dept) {
        if (ToolUtil.isEmpty(dept.getPid()) || dept.getPid().equals(0)) {
            dept.setPid(0);
            dept.setPids("[0],");
        } else {
            int pid = dept.getPid();
            CcSysDept temp = deptMapper.selectById(pid);

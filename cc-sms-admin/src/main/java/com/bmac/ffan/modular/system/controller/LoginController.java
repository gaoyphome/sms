...
import com.bmac.ffan.core.util.ApiMenuFilter;
...
public class LoginController extends BaseController {
    ...
    public String index(Model model) {
        ...
        CcSysUser user = userMapper.selectById(id);
    ...
    public String loginVali() {
        ...
        System.out.println("-----------运营公司ID登录----------->"+shiroUser.deptId);
        super.getSession().setAttribute("companyId",shiroUser.deptId);

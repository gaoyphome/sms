package com.bmac.ffan.core.shiro.factory;
...
public class ShiroFactroy implements IShiro {
    ...
    @Override
    public CcSysUser user(String account) {

        CcSysUser user = userMgrDao.getByAccount(account);
    ...
    @Override
    public ShiroUser shiroUser(CcSysUser user) {
    ...
    @Override
    public SimpleAuthenticationInfo info(ShiroUser shiroUser, CcSysUser
            user, String realmName) {

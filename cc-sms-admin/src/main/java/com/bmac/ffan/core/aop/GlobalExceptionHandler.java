package com.bmac.ffan.core.aop;

import com.bmac.ffan.common.exception.BizExceptionEnum;
import com.bmac.ffan.common.exception.BussinessException;
import com.bmac.ffan.common.exception.InvalidKaptchaException;
import com.bmac.ffan.core.base.tips.ErrorTip;
import com.bmac.ffan.core.log.LogManager;
import com.bmac.ffan.core.log.factory.LogTaskFactory;
import com.bmac.ffan.core.shiro.ShiroKit;
import com.bmac.ffan.modular.basebusiness.poixls.LineInfoFileConstant;
...
import static com.bmac.ffan.core.support.HttpKit.getIp;
import static com.bmac.ffan.core.support.HttpKit.getRequest;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ParseLineInfoException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    public ErrorTip importfile(ParseLineInfoException e, Model model) {
        String username = getRequest().getParameter("username");
        LogManager.me().executeLog(LogTaskFactory.loginLog(username, e.getMsg(), getIp()));
        model.addAttribute("tips", e.getMsg());
        System.out.println("-------"+e.getMsg());
        System.out.println("-------"+LineInfoFileConstant.encode(e.getMsg()));
        return new ErrorTip(500, LineInfoFileConstant.encode(e.getMsg()));
    }
